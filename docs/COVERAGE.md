...
| Python SDK     | `quickstart`, `primitives`, `agentic` | sync/async callers, adapter lifecycle, typed opaque agent, unit tests, and end-to-end smoke |
...
The `agentic` package is deliberately credential-free and explicitly opaque. Its outer operation's
