...
| [Strands Agent](docs/agent-quickstart.md) | `agent_quickstart` | one opaque Agent invocation, deterministic local model, fresh state per attempt, and optional Bedrock |
