...
| [One loan, five workflows](docs/primitives.md#see-five-separate-workflows-for-one-loan) | `primitives.loan_journey` | five independent roots with one resource ID and a real document-check child; simulated work only |
